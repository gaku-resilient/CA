  ...
  return (
    <ErrorBoundary>
      <div className=" bg-white overflow-hidden  ">
        {/* Hero Section */}
        <div className="relative min-h-screen overflow-hidden pt-43">
                          ...
                          {index === 2 && (
                            <div className="block">
                              <span className="relative">
                                ...
                                <div className="absolute -bottom-1 lg:-bottom-2 left-0 w-full h-1 lg:h-2 bg-[#52ab98]" />
                              </span>
                            </div>
                          )}
                        </span>
...
<a href="/contact">
                  ...
                  <div className="absolute -bottom-8 -left-8 w-12 h-12 border-2 border-white/40 backdrop-blur-sm hidden lg:flex items-center justify-center rounded-full">
