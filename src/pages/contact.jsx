...
//       secondary: '+91-9975835302 ',
//       color: 'bg-black'
//     },
//     {
//       icon: Mail,
//       title: 'EMAIL',
//       primary: 'vittamintegrityservices@gmail.com',
//       secondary: 'vittamintegrityservices@gmail.com',
//       color: 'bg-black'
//     },
//     {
//       icon: MapPin,
//       title: 'OFFICE',
//       primary: ' 16046, Tower 16,',
//       secondary: ' Prestige Song of the South,Begur Road, Yelanahalli, Bangalore, Karnataka 560068',
//       color: 'bg-black'
//     },
//     {
//       icon: Clock,
//       title: 'AVAILABILITY',
//       primary: 'Available for clients across global time zones',
...
//         <meta name="description" content="Contact Vittam Chartered Accountants in Mumbai. Expert CA services, tax planning, audit services. Call +91 98765 43210 or email vittamintegrityservices@gmail.com. Free consultation available." />
...
//          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-6 max-w-7xl mx-auto">
//   {contactInfo.map((info, index) => (
//     <div
//       key={index}
//       className={`bg-gradient-to-br ${info.color} p-1 rounded-3xl transform hover:scale-105 transition-all duration-500 shadow-xl will-change-transform min-w-0`}
//       data-animate
//       style={{
//         opacity: animatedElements.has(index) ? 1 : 0,
//         transform: `translateY(${animatedElements.has(index) ? 0 : 20}px)`,
//         transition: 'opacity 0.6s ease-out, transform 0.6s ease-out',
//       }}
//     >
//       <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-3xl h-full space-y-4 sm:space-y-6 hover:bg-opacity-95 transition-colors duration-300 flex flex-col justify-between min-w-0">
//         <div className="text-center space-y-3 sm:space-y-4">
//           <div
//             className={`w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-gradient-to-br ${info.color} mx-auto flex items-center justify-center rounded-full shadow-md group-hover:rotate-12 transition-transform duration-300 shrink-0`}
//           >
//             <info.icon className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-white" />
//           </div>
//           <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black truncate">{info.title}</h3>
//         </div>
//         <div className="space-y-2 text-center">
//           <p className="text-sm sm:text-base lg:text-lg font-semibold text-black truncate">{info.primary}</p>
//           <p className="text-xs sm:text-sm lg:text-base text-neutral-700 font-medium line-clamp-2">{info.secondary}</p>
//         </div>
//       </div>
//     </div>
//   ))}
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/your-form-id', {
        ...
        body: JSON.stringify({
          ...formData,
          _subject: 'New Contact Form Submission from Vittam Website',
        }),
      });
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      primary: '16046, Tower 16,',
      secondary:
        'Prestige Song of the South, Begur Road, Yelanahalli, Bangalore, Karnataka 560068',
      color: 'bg-black',
    },
    {
      icon: Clock,
  ...
  // Map configuration
  const mapCenter = { lat: 12.861892, lng: 77.612539 };
  const address =
    '16046, Tower 16, Prestige Song of the South, Begur Road, Yelanahalli, Bangalore, Karnataka 560068';
  ...
  return (
    <div className="bg-[#ffffff] font-roboto min-h-screen overflow-x-hidden pt-10">
      <Helmet>
        <title>
          Contact Vittam Chartered Accountants - Mumbai's Leading CA Firm
        </title>
        <meta
          name="description"
          content="Contact Vittam Chartered Accountants in Mumbai. Expert CA services, tax planning, audit services. Call +91 98765 43210 or email vittamintegrityservices@gmail.com. Free consultation available."
        />
        <meta
          name="keywords"
          content="contact chartered accountant Mumbai, CA firm contact, tax consultant Mumbai, audit services contact, business consulting Mumbai"
        />
      </Helmet>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28 md:pt-36 pb-16 sm:pb-20 md:pb-24">
          <div className="text-center space-y-8 sm:space-y-10" data-animate>
            <nav className="text-sm font-medium" aria-label="Breadcrumb">
              <ol className="flex justify-center space-x-2 text-neutral-700">
                <li>
                  <a
                    href="/"
                    className="hover:text-[#2b5477] transition-colors duration-300"
                ...
                <li
                  className="before:content-['/'] before:mx-2 text-neutral-700"
                  aria-current="page"
                >
                  Contact Us
                </li>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-neutral-700 max-w-4xl mx-auto leading-relaxed font-medium">
                Ready to transform your financial future? Get in touch with
                Mumbai's most trusted chartered accountancy firm for expert
                consultation and seamless service.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto pt-12 sm:pt-16">
              {[
                ...
                <div
                  key={index}
                  className="text-center group cursor-pointer p-4 rounded-2xl hover:bg-[#ffffff] hover:shadow-lg transition-all duration-300"
                >
                  <div className="text-3xl sm:text-4xl md:text-5xl font-black text-black mb-3 transform group-hover:scale-110 transition-transform">
                    {stat.value}
                  </div>
                  <div className="text-sm sm:text-base text-neutral-700 font-bold uppercase tracking-wide">
                    {stat.label}
                  </div>
                </div>
              ))}
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-[#f2f2f2]" id="contact-info">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className="text-center space-y-6 sm:space-y-8 mb-12 sm:mb-16 md:mb-20"
            data-animate
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-black">
              GET IN TOUCH
              ...
              >
                <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-3xl h-full space-y-4 sm:space-y-6 hover:bg-opacity-95 transition-colors duration-300 flex flex-col justify-between min-w-0">
                  <div className="text-center space-y-3 sm:space-y-4">
                    ...
                    <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-black truncate">
                      {info.title}
                    </h3>
                  </div>
                  <div className="space-y-2 text-center">
                    <p className="text-sm sm:text-base lg:text-lg font-semibold text-black truncate">
                      {info.primary}
                    </p>
                    <p className="text-xs sm:text-sm lg:text-base text-neutral-700 font-medium line-clamp-2">
                      {info.secondary}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div className="space-y-8 sm:space-y-10" data-animate>
              <div className="space-y-4">
                ...
                <p className="text-base sm:text-lg text-neutral-700 font-medium">
                  ...
                  hours with expert advice tailored to your needs.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-2">
                  <label
                    className="text-sm font-bold text-black uppercase tracking-wide"
                    htmlFor="serviceBrief"
                  >
                    Nature of Service in Brief (100 words max)
                  </label>
                  <div className="relative">
                    <MessageSquare className="absolute left-4 top-6 w-5 h-5 text-neutral-700" />
                    <textarea
            ...
            <div className="space-y-8 sm:space-y-10" data-animate>
              ...
              <div className="bg-gradient-to-br from-[#19426c] to-[#5289ab] p-1 rounded-3xl shadow-2xl min-w-0">
                <div className="relative bg-[#f2f2f2] rounded-3xl h-80 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm rounded-3xl">
                    <div className="text-center space-y-4 px-4 sm:px-6">
                      <MapPin className="w-12 h-12 sm:w-16 sm:h-16 text-white mx-auto" />
                      <h3 className="text-lg sm:text-2xl font-bold text-white">
                        Our Location
                      </h3>
                      <p className="text-sm sm:text-lg text-white/90 font-medium max-w-md line-clamp-3">
                        {address}
                      </p>
                      <a
                        href={googleMapsUrl}
                      ...
                      >
                        <button
                          className="bg-[#204474] text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold text-sm sm:text-base hover:bg-[#5286ab] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#5289ab] active:scale-95"
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  { icon: Calendar, title: 'Book Appointment', desc: 'Schedule a meeting' },
                  {
                    ...
                    desc: 'Online meetings available',
                  },
                  { icon: Calculator, title: 'Free Assessment', desc: 'Initial consultation' },
                  {
                    icon: CheckCircle,
                  ...
                  <div
                    key={index}
                    className="bg-[#f2f2f2] p-6 rounded-2xl hover:bg-[#ffffff] hover:shadow-lg transition-all duration-300 text-center space-y-3"
                  >
                    <feature.icon className="w-8 h-8 text-black mx-auto" />
                    <h4 className="font-bold text-black text-sm">{feature.title}</h4>
                    <p className="text-xs text-neutral-700">{feature.desc}</p>
            ...
            {[
              {
                ...
                title: '500+ Satisfied Clients',
                description:
                  'Join hundreds of businesses who trust us with their financial success and compliance needs.',
              },
              {
                icon: Clock,
                title: '24-Hour Response',
                description:
                  'We understand urgency in business. Get expert responses to your queries within 24 hours.',
              },
              {
                icon: Award,
                title: 'ICAI Certified Experts',
                description:
                  'Our team of certified chartered accountants brings 15+ years of industry expertise.',
              },
            ].map((item, index) => (
              <div
                key={index}
                className="bg-gradient-to-br bg-[#082245] backdrop-blur-lg p-8 rounded-3xl hover:bg-opacity-30 transition-all duration-300 transform hover:scale-105 group border border-[#ffffff] border-opacity-30 shadow-md hover:shadow-xl"
                data-animate
              >
                <div className="space-y-6">
                  <div className="w-16 h-16 bg-[#ffffff] bg-opacity-20 rounded-full flex items-center justify-center group-hover:rotate-12 transition-transform shadow-lg">
                  ...
                  <h3 className="text-xl font-black text-white">{item.title}</h3>
                  <p className="text-base leading-relaxed font-medium opacity-90 text-white">
                    {item.description}
                  </p>
                </div>
              </div>
            ...
            {[
              {
                question: 'How quickly can you respond to my query?',
                answer:
                  'We guarantee a response within 24 hours for all inquiries. For urgent matters, call us directly for immediate assistance.',
              },
              {
                question: 'Do you offer free initial consultation?',
                answer:
                  'Yes! We provide a complimentary 30-minute consultation to understand your needs and explain how we can help your business.',
              },
              {
                question: 'What documents should I bring for the meeting?',
                answer:
                  'Bring relevant financial records, previous tax returns, bank statements, and any specific documents related to your inquiry.',
              },
              {
                question: 'Do you handle both individual and business clients?',
                answer:
                  'Absolutely! We serve individuals, startups, SMEs, and large corporations across various industries with customized solutions.',
              },
            ].map((faq, index) => (
              <div
                key={index}
                className="bg-[#ffffff] p-6 sm:p-8 rounded-2xl border-2 border-[#c8d8e4] hover:border-[#073257] transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <h3 className="text-lg sm:text-xl font-black text-black mb-4">
                  {faq.question}
                </h3>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-[#ffffff]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-animate>
          <div className="space-y-8 sm:space-y-10">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-neutral-700 leading-relaxed font-medium max-w-4xl mx-auto">
              Don't wait - secure your financial future today. Contact Mumbai's
              most trusted chartered accountancy firm and experience the
              difference expertise makes.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center pt-8">
              <button
                className="bg-[#1d3f6e] text-[#ffffff] px-12 py-6 font-black text-xl rounded-xl hover:bg-[#5280ab] transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3 shadow-xl hover:shadow-2xl"
                aria-label="Call now to contact us"
              >
                <Phone className="w-6 h-6" />
                <span>CALL NOW</span>
              </button>
              <button
                className="border-2 border-[#0e477d] text-black px-12 py-6 font-black text-xl rounded-xl hover:bg-[#2b4d77] hover:text-[#ffffff] transition-all duration-300 shadow-xl"
      ...
      <style>
        ...
        .animate {
          animation: vittam-fadeIn 0.4s ease-out forwards;
        }
