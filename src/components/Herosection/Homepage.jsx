...
//                       <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3 group-hover:text-grey transition-colors duration-300">
//                         {benefit.title}
//                       </h3>
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <div className={`space-y-6 lg:space-y-8 transform transition-all duration-1000 ${
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium text-white leading-tight lg:leading-none tracking-tight">
                    ...
                    <div className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed max-w-2xl space-y-2">
                  ...
                  {/* Action Buttons */}
                  <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 transform transition-all duration-700 delay-1000 ${
                    isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                  }`}>
                    <button 
                      onClick={handleGetStarted}
                      className="group bg-white text-[#123956] px-6 sm:px-8 py-3 sm:py-4 font-bold text-base sm:text-lg hover:bg-[#123956] hover:text-white transition-all duration-300 flex items-center justify-center space-x-2 sm:space-x-3 transform hover:scale-105 hover:shadow-2xl active:scale-95"
                    >
                    ...
                    <button 
                      ...
                      className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 font-bold text-base sm:text-lg hover:bg-white hover:text-[#123956] transition-all duration-300 transform hover:scale-105 backdrop-blur-sm active:scale-95"
                    >
                      SCHEDULE CALL
                    </button>
                  </div>
                  ...
                  {/* Dynamic Stats */}
                  <div className={`grid grid-cols-3 gap-4 sm:gap-8 pt-6 sm:pt-8 border-t-2 border-white/30 transform transition-all duration-700 delay-1200 ${
                    isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                  }`}>
                    {Object.entries(currentSlideData.stats).map(([key, value], index) => (
                      <div key={key} className="text-center group cursor-pointer">
                        <div className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 sm:mb-2 transform group-hover:scale-110 transition-transform duration-300">
                          {value}
                        </div>
                ...
                <div className={`relative mt-8 lg:mt-0 transform transition-all duration-1000 delay-300 ${
                  ...
                  <div className="relative z-10 transform hover:scale-105 transition-all duration-500">
                    <div className="bg-white/10 backdrop-blur-lg p-1 shadow-2xl border border-white/20 rounded-lg">
                      <div className="bg-white/95 backdrop-blur-sm p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8 rounded-lg">
                        
                        {/* Professional Avatar */}
                        <div className="flex items-center space-x-3 sm:space-x-4 border-b-2 border-gray-200 pb-4 sm:pb-6">
                          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#49779a] to-[#123956] flex items-center justify-center rounded-full transform hover:rotate-12 transition-transform duration-300 shadow-lg flex-shrink-0">
                            <Users className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                          </div>
                          <div className="min-w-0 flex-1">
                            <h3 className="text-lg sm:text-xl font-black text-[#123956] leading-tight">Vittam Integrity Services</h3>
                            <p className="text-xs sm:text-sm text-gray-600 font-bold uppercase tracking-wide leading-tight">Expert Financial Solutions</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          {[
                            ...
                            <div key={index} 
                                 className={`flex items-center justify-between p-3 sm:p-4 border-2 border-gray-200 hover:border-[#2b6777] transition-all duration-300 group hover:shadow-lg transform hover:scale-102`}>
                              <div className="flex items-center space-x-3 sm:space-x-4 min-w-0 flex-1">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-gray-100 to-gray-200 group-hover:from-[#2b6777] group-hover:to-[#33495a] flex items-center justify-center rounded-full transition-all duration-300 shadow-md flex-shrink-0">
                                  <service.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#123956] group-hover:text-white transition-colors duration-300" />
                                </div>
                                <span className="font-bold text-sm sm:text-base text-[#123956] truncate">{service.title}</span>
                              </div>
                        ...
                        <button 
                          ...
                          className="w-full bg-gradient-to-r from-[#2b6777] to-[#123956] text-white py-3 sm:py-4 font-black text-base sm:text-lg hover:from-[#123956] hover:to-[#2b6777] transition-all duration-300 transform hover:scale-105 hover:shadow-xl active:scale-95 rounded-lg"
                        >
                  ...
                  {/* Floating Elements */}
                  <div className="absolute -top-8 -right-8 w-16 h-16 border-4 border-white/30 animate-spin backdrop-blur-sm hidden lg:flex items-center justify-center rounded-full" 
                       style={{ animationDuration: '10s' }}>
                    <TrendingUp className="w-6 h-6 text-white" />
                  </div>
                  <div className="absolute -bottom-8 -left-8 w-12 h-12 border-2 border-white/40 animate-bounce backdrop-blur-sm hidden lg:flex items-center justify-center rounded-full">
          ...
          <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-20">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <button onClick={prevSlide} 
                      className="p-2 sm:p-3 bg-white/20 backdrop-blur-md border border-white/30 text-white hover:bg-white/30 transition-all duration-300 rounded-full active:scale-95">
