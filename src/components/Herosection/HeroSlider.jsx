...
const ModernHeroSection = () => {
    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          >
            <Phone className="w-5 h-5 text-[#123956]" />
            <span>91-9975835302 </span>
          </a>
          <a 
            href="mailto:contact@vittamintegrity.com" 
            className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 transition-colors"
          >
          ...
          <button 
            ...
            className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 transition-colors w-full"
          >
  ...
  return (
    <div className="relative min-h-screen overflow-hidden  ">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className={`relative mt-8 lg:mt-0 transform transition-all duration-1000 delay-300 ${
              ...
              <div className="relative z-10 transform hover:scale-105 transition-all duration-500">
                <div className="bg-white/10 backdrop-blur-lg p-1 shadow-2xl border border-white/20">
                  <div className="bg-white/95 backdrop-blur-sm p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8">
                    
                    {/* Professional Avatar */}
                    <div className="flex items-center space-x-3 sm:space-x-4 border-b-2 border-[#c8d8e4] pb-4 sm:pb-6">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#49779a] to-[#123956] flex items-center justify-center rounded-full transform hover:rotate-12 transition-transform shadow-lg flex-shrink-0">
                        <Users className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h3 className="text-lg sm:text-xl font-black text-[#123956] leading-tight">Vittam Integrity Services</h3>
                        <p className="text-xs sm:text-sm text-[#223b4e] font-bold uppercase tracking-wide leading-tight">Founder and Partner</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      {[
                        ...
                        <div key={index} 
                             className={`flex items-center justify-between p-3 sm:p-4 border-2 border-[#c8d8e4] hover:border-[#2b6777] transition-all duration-300 group hover:shadow-lg transform transition-all duration-500`}
                             style={{ transitionDelay: `${index * 100}ms` }}>
                          <div className="flex items-center space-x-3 sm:space-x-4 min-w-0 flex-1">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#f2f2f2] to-[#e0e0e0] group-hover:from-[#2b6777] group-hover:to-[#33495a] flex items-center justify-center rounded-full transition-all shadow-md flex-shrink-0">
                              <service.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#123956] group-hover:text-white transition-colors" />
                            </div>
      ...
      {/* Slider Controls - Enhanced Mobile */}
