...
const ImageGallery = () => {
  ...
  const images = [
    {
      ...
      src: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=1200&h=800&fit=crop',
      thumb: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=400&h=300&fit=crop'
    },
    {
      id: 2,
      title: 'Urban Sunset',
    ...
    },
    {
      ...
      thumb: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      thumb: 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=400&h=300&fit=crop'
    },
    {
      id: 7,
      title: 'Modern Building',
      src: 'https://images.unsplash.com/photo-1486718448742-163d73305c09?w=1200&h=800&fit=crop',
      thumb: 'https://images.unsplash.com/photo-1486718448742-163d73305c09?w=400&h=300&fit=crop'
    },
    {
      id: 8,
      title: 'Forest Path',
    ...
    },
    {
      ...
      thumb: 'https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=400&h=300&fit=crop'
    }
  ];
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <header className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-amber-400 to-amber-300 bg-clip-text text-transparent mb-6">
            Image Gallery
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((image, index) => (
            <div
              key={image.id}
              className="group relative bg-slate-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 cursor-pointer"
