...
//               {/* Address */}
//               <div className="flex items-start space-x-3 sm:space-x-4 group">
//                 <div className="w-8 sm:w-10 h-8 sm:h-10 bg-[#f2f2f2] rounded-full flex items-center justify-center group-hover:bg-[#ffffff] group-hover:text-[#2b6777] transition-all duration-300">
//                   <MapPin className="w-4 sm:w-5 h-4 sm:h-5" />
//                 </div>
//                 <div>
